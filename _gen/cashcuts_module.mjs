/**
 * Generador módulo CashCuts – Index + Show + helpers
 * node _gen/cashcuts_module.mjs
 */
...
/* ══════════════════════════════════════════════════════════════════════════
   Components/CashCuts/SummaryCards.vue
   ══════════════════════════════════════════════════════════════════════════ */
const SUMMARY_CARDS = `<script setup>
defineProps({
...
/* ══════════════════════════════════════════════════════════════════════════
   Components/CashCuts/PaymentBreakdown.vue
   ══════════════════════════════════════════════════════════════════════════ */
const PAYMENT_BREAKDOWN = `<script setup>
defineProps({
...
<template>
  ...
  <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200">
      ...
      <!-- Lista móvil -->
      <ul v-else class="sm:hidden divide-y divide-gray-100">
...
/* ══════════════════════════════════════════════════════════════════════════
   Pages/CashCuts/Show.vue
   ══════════════════════════════════════════════════════════════════════════ */
const SHOW_PAGE = `<script setup>
...
/* ── Escribir archivos ──────────────────────────────────────────────────── */
write('Components/CashCuts/SummaryCards.vue',    SUMMARY_CARDS);
write('Components/CashCuts/PaymentBreakdown.vue', PAYMENT_BREAKDOWN);
write('Pages/CashCuts/Index.vue',                INDEX_PAGE);
write('Pages/CashCuts/Show.vue',                 SHOW_PAGE);
